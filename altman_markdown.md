...
[영상참고](https://youtu.be/540vzMlf-54?si=17_RqZhRAKkaDv7s)
...
- 이미지가 존재한다
> 이미지 소개: 여러 언어에 걸친 MMLU의 GPT-4 3-샷 정확도(Azure Translate를 사용하여 57개 주제에 걸친 14,000개의 객관식 문제 모음인 MMLU 벤치마크를 다양한 언어로 번역. 테스트한 26개 언어 중 24개 언어에서 GPT-4는 라트비아어, 웨일스어, 스와힐리어와 같은 리소스가 적은 언어를 포함하여 GPT-3.5 및 기타 LLM(Chinchilla, PaLM)의 영어 성능을 능가
...
### 회고록
**샘 알트만**은 ABC 방송 인터뷰에서 GPT-4 출시와 AI 기술에 대한 사회적 영향에 대해 이야기 했습니다. GPT-4는 괄목할만한 성장을 이미지와 텍스트에 대한 강력한 추론 능력을 가지고 있으며, Bar Examination (변호사 시험)등에서 완벽하진 않지만 월등한 성능을 보여준다고 하였다. 하지만 GPT-4는 hallucination (허위 정보)에 대해서 아직 완벽하게 대응하지 못하며, 사이버 공격에도 악용할 수 있다고 우려했다. 악용될 수 있는 포인트들이 있어서, 전문가를 비롯하여 범사회적으로 디스커션을 해야한다는 필용성을 이야기 합니다. 또한 GPT-4는 유료 서비스로도 나오고 있으며, AI 모델의 성능평가를 위한 "에벌즈" 라는 소프트웨어 프레임워크도 공개되어있습니다.

### 이 노드를 마무리하며, 

사람들과 협업할 수 있는 툴인 깃/깃헙 사용법을 배웠습니다. CS 관련 일들을 한다면, 꼭 쓰인다는 툴을 배웠습니다. 이것을 통해서 AI를 공부하고 협업하는 사람이 되겠습니다.
또한 두 가지의 아티클들을 읽었는데요.. AI의 유용성을 배울 수 있었으며, 이 유용성을 길게 갖고 갈 수 있는 사회적 합의점도 있어야 한다는 필요성도 배웠습니다.
